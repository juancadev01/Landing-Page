...
export default function Home() {
  ...
  const whatsappMessage = encodeURIComponent("Hola, vi la página web de Correa & Asociados y estoy interesado en recibir asesoría jurídica.");

  return (
    <main>
      <header className={scrolled ? "site-header is-scrolled" : "site-header"}>
        <a className="brand" href="#inicio" aria-label="Correa & Asociados, inicio" onClick={closeMenu}>
          <span className="brand-mark official-mark" aria-hidden="true" />
          <span><b>CORREA</b><small>&amp; ASOCIADOS</small></span>
        </a>
      ...
      <section className="hero" id="inicio">
        ...
        <div className="hero-content reveal">
          <p className="eyebrow">ASESORÍA JURÍDICA Y REPRESENTACIÓN LEGAL <span /></p>
      ...
      <section className="about section" id="nosotros">
        <div className="about-image reveal">
          ...
          <div className="image-note"><span className="image-note-logo" aria-hidden="true" /><p>Su caso merece atención<br /><b>rigurosa y personal</b></p></div>
        </div>
        <div className="about-copy reveal">
          <p className="eyebrow dark">QUIÉNES SOMOS <span /></p>
          <h2>Experiencia jurídica<br /><em>a su servicio</em></h2>
          <p className="lead">Correa &amp; Asociados es una firma comprometida con la defensa de los intereses de sus clientes.</p>
      ...
      <section className="contact section" id="contacto">
        <div className="contact-info reveal">
          ...
          <div className="contact-data">
            <a href={`tel:${CONTACT.phone.replace(/\s/g, "")}`}><i>☎</i><span><small>{CONTACT.name.toUpperCase()} · TELÉFONO / WHATSAPP</small>{CONTACT.phone}</span></a>
      ...
      <footer>
        <div className="footer-main">
          <div className="footer-brand"><a className="brand" href="#inicio"><span className="brand-mark official-mark" /><span><b>CORREA</b><small>&amp; ASOCIADOS</small></span></a><p>Asesoría jurídica y representación legal<br />con compromiso y confianza.</p></div>
        ...
        <div className="footer-bottom"><p>© {new Date().getFullYear()} Correa &amp; Asociados. Todos los derechos reservados.</p><p>Defensa · Estrategia · Confianza</p></div>
      </footer>
